...
public class ColorPickerView extends View {
    ...
    public ColorPickerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.PALETTE_CIRCLE_TRACKER_RADIUS = AppConst.ZOOM_MAX;
    ...
    private int pointToAlpha(int x) {
        ...
        return 255 - ((x * BallSpinFadeLoaderIndicator.ALPHA) / width);
    }
            ...
            switch (this.mLastTouchedPanel) {
                ...
                case 2:
                    if (this.mShowAlphaPanel && this.mAlphaRect != null) {
                        ...
                        if (alpha < 0) {
                            alpha = 0;
                        } else if (alpha > BallSpinFadeLoaderIndicator.ALPHA) {
                            alpha = BallSpinFadeLoaderIndicator.ALPHA;
                        }
                        this.mAlpha = alpha;
                        update = true;
                        break;
    ...
    private void setUpAlphaRect() {
        if (this.mShowAlphaPanel) {
            ...
            this.mAlphaPattern = new AlphaPatternDrawable((int) (AppConst.ZOOM_MAX * this.mDensity));

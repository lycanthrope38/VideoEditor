        ...
        if (this.mColorPickerDialog == null) {
            ...
            this.mColorPickerDialog.setOnColorChangedListener(new OnColorChangedListener() {
                public void onColorChanged(int color) {
                    RectanglePhoto.this.color = color;
                    for (int i = RectanglePhoto.NONE; i < RectanglePhoto.this.listBorder.size(); i += RectanglePhoto.DRAG) {
                        ((Sprite) RectanglePhoto.this.listBorder.get(i)).setColor(((float) android.graphics.Color.red(color)) / 255.0f, ((float) android.graphics.Color.green(color)) / 255.0f, ((float) android.graphics.Color.blue(color)) / 255.0f, HandlerTools.ROTATE_R);
                    }
                }
            });
        }
